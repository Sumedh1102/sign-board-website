...
export default function TeamSection() {
  ...
  return (
    <section
      ref={fade.ref}
      className={`py-20 lg:py-12 bg-slate-50 transition-all duration-700 ${
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <p className="text-blue-600 uppercase tracking-[3px] text-sm font-semibold mb-4">
            THE PEOPLE BEHIND SANTOSH SIGN WORKS
          </p>
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-900">
            Passionate Minds. Creative Hearts.
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member) => (
            <div
              key={member.name}
              className="group bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-xl hover:border-blue-200 transition-all duration-500"
            >
              <div className="flex items-center gap-4">
                {/* Avatar */}
                <div className="w-14 h-14 rounded-full overflow-hidden shrink-0 ring-2 ring-blue-100 group-hover:ring-blue-300 transition-all duration-300">
                  <img
                    src={member.image}
                    alt={member.name}
