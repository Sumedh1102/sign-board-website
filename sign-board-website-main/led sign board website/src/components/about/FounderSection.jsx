          ...
          <div className="lg:pl-6">
            ...
            <div className="space-y-6">
              <p className="text-slate-600 text-lg leading-relaxed italic border-l-4 border-blue-600 pl-6 bg-slate-50 p-4 rounded-r-lg">
                "When I started LUMI, my vision was simple: to help businesses stand out and make a lasting impression. I realized that a sign is often the first interaction a customer has with a brand, and it needs to speak volumes about their quality and professionalism."
              </p>
            ...
            <div className="mt-10">
              ...
              <p className="text-blue-600 font-medium mt-1">Founder & CEO, LUMI</p>
            </div>
          </div>
        </div>
      </div>
