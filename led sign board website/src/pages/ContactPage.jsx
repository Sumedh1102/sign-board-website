      ...
      <section className="py-16 lg:py-24" ref={contentFade.ref}>
        ...
        <div className="w-11 h-11 rounded-full border-4 bg-white flex items-center justify-center text-black shrink-0">
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-1">
                      <a href="mailto:info@lumisignage.com" className="block text-xs text-slate-700 hover:text-blue-600 font-medium transition-colors">
                        General: <span className="font-semibold text-slate-900 hover:text-blue-600">info@lumisignage.com</span>
                      </a>
                      <a href="mailto:support@lumisignage.com" className="block text-xs text-slate-700 hover:text-blue-600 font-medium transition-colors">
                        Support: <span className="font-semibold text-slate-900 hover:text-blue-600">support@lumisignage.com</span>
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-xl overflow-hidden bg-white transition-shadow duration-300">
                <div className="relative aspect-[16/10] sm:aspect-[16/8] lg:aspect-[16/10] rounded-xl overflow-hidden bg-slate-100">
                  <iframe 
                    ...
                    title="Lumi LED Signage Location Map"
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <p className="text-sm text-slate-500 mt-2">
              Everything you need to know about starting a project with LUMI LED Signage.
            </p>
          </div>
