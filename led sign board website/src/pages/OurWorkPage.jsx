...
const projects = [
  {
    ...
    location: 'Mumbai, MH',
    year: '2025',
    description: 'Premium backlit acrylic 3D letters with warm-white LED glow for a cosy café ambiance.',
  ...
  },
  {
    ...
    featured: true,
    tags: ['Outdoor', 'Pylon Sign', 'Hospitality'],
    client: 'Royal Hotels Group',
  },
  {
    id: 'trends-store',
    title: 'Trends Retail Store',
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-slate-100 flex-shrink-0">
        ...
        >
          ...
          <div
            slot="handle"
            className="w-10 h-10 bg-white rounded-full shadow-lg border-2 border-slate-200 flex items-center justify-center cursor-ew-resize hover:scale-105 active:scale-95 transition-transform duration-200 select-none z-10"
          >
        ...
        {/* Day / Night badges */}
        <div className="absolute top-3 left-3 bg-black/40 backdrop-blur-md text-white text-[9px] font-bold tracking-wider px-2.5 py-1 rounded-md pointer-events-none z-10 uppercase">
          DAY
        </div>
        <div className="absolute top-3 right-3 bg-black/40 backdrop-blur-md text-white text-[9px] font-bold tracking-wider px-2.5 py-1 rounded-md pointer-events-none z-10 uppercase">
          NIGHT
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-5 text-lg text-slate-500 leading-relaxed">
            Drag the slider on any card to compare the day and night look of each installation.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                  ...
                  >
                    ...
                    <div
                      slot="handle"
                      className="w-10 h-10 bg-white rounded-full shadow-lg border-2 border-slate-200 flex items-center justify-center cursor-ew-resize hover:scale-105 transition-transform duration-200 select-none z-10"
                    >
                      <div className="w-1.5 h-1.5 bg-slate-500 rounded-full" />
                    </div>
                  </img-comparison-slider>
