...
const testimonials = [
  {
    ...
    review:
      "LUMI LED Signage completely transformed our storefront. The quality, brightness, and finishing are absolutely premium!",
  },
  {
    name: "Priya Sharma",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-slate-500 max-w-2xl mx-auto">
            Real stories from brands that chose LUMI LED Signage to shine
            brighter.
          </p>
        </div>
